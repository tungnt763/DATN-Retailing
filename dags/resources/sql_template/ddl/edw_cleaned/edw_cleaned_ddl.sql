...
CREATE TABLE IF NOT EXISTS `datn-retailing.edw_cleaned.transactions` (
    ...
    trn_date                  DATETIME NOT NULL OPTIONS(description="{\"clmn_lgcl_name_eng\": \"Date\", \"clmn_desc\": \"Date of the transactions table\"}"),
    trn_dscnt                 NUMERIC  OPTIONS(description="{\"clmn_lgcl_name_eng\": \"Discount\", \"clmn_desc\": \"Discount of the transactions table\"}"),
